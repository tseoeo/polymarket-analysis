    ...
    <Card className="p-4">
      <div className="flex items-start justify-between mb-3">
        ...
        {item.new_alerts_count > 0 && (
          <span className="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded border bg-red-50 text-red-700 border-red-200">
      ...
      {data && data.items.length > 0 && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/briefing" className="text-sm text-blue-600 hover:text-blue-700">
