    ...
    <div className="page-container">
      ...
      {activeTab === 'pullbacks' && (
        <>
          ...
          {pullbacksError && (
            <div className="text-red-600 py-4">Failed to load MM pullbacks</div>
          )}
      ...
      {activeTab === 'hours' && (
        <>
          ...
          {hoursError && (
            <div className="text-red-600 py-4">Failed to load trading hours</div>
          )}
          ...
          {bestHours && bestHours.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card className="p-4 md:col-span-2">
                <h3 className="font-semibold text-gray-900 mb-4">24-Hour Quality Heatmap</h3>
                <div className="grid grid-cols-6 md:grid-cols-12 gap-1">
                  {Array.from({ length: 24 }, (_, i) => {
                    ...
                    const bgColor =
                      ...
                      quality >= 0.5 ? 'bg-emerald-300' :
                      quality >= 0.3 ? 'bg-yellow-300' :
                      quality >= 0.1 ? 'bg-orange-300' :
                      'bg-gray-200';
                    ...
                    return (
                      ...
                      >
                        <span className={quality >= 0.5 ? 'text-white' : 'text-gray-700'}>
              ...
              {/* Top Hours List */}
              <Card className="p-4">
                <h3 className="font-semibold text-gray-900 mb-4">Top 5 Trading Hours</h3>
              ...
              <Card className="p-4">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Avg Spread (best hour):</span>
                    <span className="font-mono">
                      {bestHours[0] ? (bestHours[0].avg_spread_pct * 100).toFixed(3) : '-'}%
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Avg Spread (worst hour):</span>
                    <span className="font-mono">
                      {bestHours.length > 0
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Best Hour Depth:</span>
                    <span className="font-mono">
